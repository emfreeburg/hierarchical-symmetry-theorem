...
%
% E. M. Freeburg --- self-contained LaTeX source.
% Builds with pdflatex (run twice).
% ======================================================================
...
% Resolve tight paragraphs with slightly looser spacing instead of
% overfull lines.
\setlength{\emergencystretch}{3em}

\subjclass[2020]{60G57, 60E10, 60G51, 60F10, 28A80, 76F55}
...
multifractal random measures, large deviations}
...
\textit{Comm.\ Math.\ Phys.}\ \textbf{236} (2003), 449--475.
...
\textit{J.\ Roy.\ Statist.\ Soc.\ Ser.\ B}\ \textbf{25} (1963),
392--393.
